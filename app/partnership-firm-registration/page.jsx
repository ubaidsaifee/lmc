...
import { Star, StarHalf, FileText, Users, Scale } from "lucide-react";
          ...
          <div>
            ...
            <div className="mt-6 space-y-6 text-slate-700">
              <div className="flex items-start gap-4">
                <Scale className="w-8 h-8 text-blue-500 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-bold text-gray-800">
                    Ensure Legal Recognition
                  </h3>
                  <p className="mt-1 text-base md:text-lg leading-relaxed text-justify">
                    Registering your firm provides formal legal status, enabling
                    you to open business bank accounts, enter into contracts,
                    and protect your business name under a unified, official
                    capacity.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <FileText className="w-8 h-8 text-blue-500 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-bold text-gray-800">
                    Formalize Partner Agreements
                  </h3>
                  <p className="mt-1 text-base md:text-lg leading-relaxed text-justify">
                    A registered partnership relies on a Partnership Deed, which
                    outlines the rights, duties, and profit-sharing ratios of
                    all partners. This formal document mitigates future disputes
                    and ensures clarity.
                  </p>
                </div>
              </div>
