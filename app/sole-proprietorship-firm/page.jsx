...
import { Star, StarHalf, FileText, Users, Scale, Rocket, UserCheck } from "lucide-react";
          ...
          <div>
            ...
            <div className="mt-6 space-y-6 text-slate-700">
              <div className="flex items-start gap-4">
                <Rocket className="w-8 h-8 text-blue-500 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-bold text-gray-800">
                    Simple and Quick Formation
                  </h3>
                  <p className="mt-1 text-base md:text-lg leading-relaxed text-justify">
                    A sole proprietorship is the easiest business structure to establish, with minimal legal formalities and low setup costs. It allows individuals to start their entrepreneurial journey swiftly and efficiently.
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <UserCheck className="w-8 h-8 text-blue-500 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-bold text-gray-800">
                    Exercise Complete Business Control
                  </h3>
                  <p className="mt-1 text-base md:text-lg leading-relaxed text-justify">
                    As the sole owner, you have absolute authority over all business decisions, operations, and profits. This structure provides maximum autonomy without interference from partners or shareholders.
                  </p>
                </div>
              </div>
            </div>
